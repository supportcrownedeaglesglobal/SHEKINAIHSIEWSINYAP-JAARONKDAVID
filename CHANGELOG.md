...
- Reworked the testimonial section into an editorial credibility archive with a featured witness quote, credibility channels, scalable testimony cards, and a recognition ledger.
- Removed the generic star-rating testimonial pattern in favor of a more documentary, dignity-preserving structure.
- Kept the changes scoped to the testimonial section and did not alter the hero, navigation, typography system, global colors, or brand identity.
...
- Changed the Exquisite International Magazine award card to open the accurate social-event video instead of an unrelated award photo.
- Organised newly added loose media files into dated import folders under `images/imported/` and `videos/imported/`, keeping the original filenames until final placement decisions are made.
